' Program that simulates the impact of different monetary policy reaction functions under ZLB and both the inflation and wage growth thresholds with VAR xpectations
...
' *************************************************************
' Simulation 2 : Taylor rule after crossing ecitrsh
' *************************************************************
...
smpl %graphstart %graphend
  ...
  fig1a.setelem(2) lcolor(green)  legend("PCE rate = 2.5%, Inertial Taylor") lwidth(1)
 fig1a.setelem(3) lcolor(red)  legend(" ECI rate = 3.5%, Taylor") lwidth(1)
  ...
  fig1b.setelem(2) lcolor(green)  legend(" PCE rate = 2.5%, Inertial Taylor") lwidth(1)
 fig1b.setelem(3) lcolor(red)  legend(" ECI rate = 3.5%, Taylor") lwidth(1)
  ...
  fig1c.setelem(2) lcolor(green)  legend("PCE rate = 2.5%, Inertial Taylor") lwidth(1)
 fig1c.setelem(3) lcolor(red)  legend(" ECI rate = 3.5%, Taylor") lwidth(1)
  ...
  fig1d.setelem(2) lcolor(green)  legend("PCE rate = 2.5%, Inertial Taylor") lwidth(1)
 fig1d.setelem(3) lcolor(red)  legend("ECI rate = 3.5%, Taylor") lwidth(1)
...
smpl %graphstart %graphend
  ...
  fig1e.setelem(2) lcolor(green)  legend("PCE rate = 2.5%, Inertial Taylor") lwidth(1)
 fig1e.setelem(3) lcolor(red)  legend(" ECI rate = 3.5%, Taylor") lwidth(1)
  ...
  fig1f.setelem(2) lcolor(green)  legend("PCE rate = 2.5%, Inertial Taylor") lwidth(1)
 fig1f.setelem(3) lcolor(red)  legend("ECI rate = 3.5%, Taylor") lwidth(1)
...
smpl %graphstart %graphend
  ...
  fig1g.setelem(2) lcolor(green)  legend("PCE rate = 2.5%, Inertial Taylor") lwidth(1)
 fig1g.setelem(3) lcolor(red)  legend("ECI rate = 3.5%, Taylor") lwidth(1)
...
smpl %graphstart %graphend
  ...
  fig1h.setelem(2) lcolor(green)  legend(" PCE rate = 2.5%, Inertial Taylor") lwidth(1)
 fig1h.setelem(3) lcolor(red)  legend("ECI rate = 3.5%, Taylor") lwidth(1)
  ...
  %title = "Macroeconomic Effects of Different Monetary Policy Reaction Functions\r(VAR Expectations"
